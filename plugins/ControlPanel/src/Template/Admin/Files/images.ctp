    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content h-100 border-0 shadow-0">
            <div class="modal-header">
                <h5 class="modal-title h2"><?= __('Detail Image') ?></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <dl class="row border-bottom pb-4">
                            <dt class="col-md-4"><?= __('Filename') ?></dt>
                            <dd class="col-md-8 text-truncate" id="filename"></dd>
                            <dt class="col-md-4"><?= __('Mime Type') ?></dt>
                            <dd class="col-md-8 text-truncate" id="mimeType"></dd>
                            <dt class="col-md-4 text-truncate"><?= __('Date Created') ?></dt>
                            <dd class="col-md-8 text-truncate" id="created"></dd>
                            <dt class="col-md-4"><?= __('Filsize') ?></dt>
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item mr-4">
                                <?php
                                echo $this->Html->link(
                                    $this->Html->tag('i', '', ['class' => 'fal fa-copy mr-1']) . __('Copy URL'),
                                    '#',
                                    [
                                        'escape' => false,
                                        'id' => 'copy',
                            ...
                            <li class="list-inline-item mr-4" id="delete">
                                ...
                                echo $this->SmartHtml->postLink(
                                    $this->Html->tag('i', '', ['class' => 'fal fa-trash mr-1']) . __('Delete'),
                                    $this->Url->build(['action' => 'delete', 'FILE_ID']),
                                    [
                                        'id' => 'deleteLink',
                                        'class' => 'color-danger-900 mt-2 pr-2 mr-auto',
                                        'data-title' => __('Are you sure you want to delete the image?'),
