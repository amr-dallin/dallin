...
return [
    ...
    'file' => '<div class="custom-file"><input type="file" class="custom-file-input" name="{{name}}"{{attrs}}><label class="custom-file-label" for="customFile">' . __d('smart_admin', 'Choose file') . '</label></div>',
    ...
    'label' => '<label{{attrs}} class="form-label sr-only">{{text}}</label>',
    // Label element used for radio and multi-checkbox inputs.
    'nestingLabel' => '<div class="custom-control custom-checkbox">{{hidden}}{{input}}<label class="custom-control-label"{{attrs}}>{{text}}</label></div>',
