                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th data-hide="phone,tablet"><?php echo __('Description'); ?></th>
                            ...
                            <?php foreach($projects as $key => $project): ?>
                                <tr>
                                    ...
                                    <td><?php echo h($project->date_created); ?></td>
                                    <td class="text-center">
                                        <?php echo $this->Dallin->published(h($project->published)); ?>
                                    </td>
                                    <td class="text-center">
                                        <?php
                                        echo $this->Html->link(
