...
$this->start('ribbon');
$breadcrumbs = [0 => ['title' => __('Projects')]];
echo $this->element('ribbon', array('breadcrumbs' => $breadcrumbs));
$this->end();

$this->start('title-heading');
echo $this->element('title', array('title' => __('Projects')));
$this->end();
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="txt-color-blueLight">
                                            <?php echo __('Alias: ') . h($project->alias); ?>
                                        </div>
                                    </td>
                                    <td><?php echo h($project->meta_keywords); ?></td>
                                    <td><?php echo h($project->published); ?></td>
                                    <td>
                                        <?php
                                        echo $this->Html->link(
