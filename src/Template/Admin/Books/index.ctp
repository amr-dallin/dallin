                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="txt-color-blueLight">
                                            <?php echo __('Alias: ') . h($book->alias); ?>
                                        </div>
                                    </td>
                                    <td><?php echo h($book->meta_keywords); ?></td>
                                    <td><?php echo h($book->date_readed); ?></td>
                                    <td><?php echo h($book->published); ?></td>
                                    <td>
                                        <?php
                                        echo $this->Html->link(
