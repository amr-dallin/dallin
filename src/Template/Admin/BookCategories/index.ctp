 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $bookCategories
 */

$this->start('title');
echo __('Book Categories');
$this->end();

$this->start('ribbon');
$breadcrumbs = [0 => ['title' => __('Book Categories')]];
echo $this->element('ribbon', array('breadcrumbs' => $breadcrumbs));
$this->end();

$this->start('title-heading');
echo $this->element('title', array('title' => __('Book Categories')));
$this->end();
                    ...
                    <div class="widget-body no-padding">
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <?php foreach($bookCategories as $key => $bookCategory): ?>
                                <tr>
                                    <td>
                                        <?php echo h($bookCategory->title); ?>
                                        <div class="txt-color-blueLight">
                                            <?php echo __('Alias: ') . h($bookCategory->alias); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <?php
